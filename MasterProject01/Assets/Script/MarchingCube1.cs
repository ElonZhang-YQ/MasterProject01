...
public class MarchingCube
{
    ...
    public static int GetCubeConfig()
    {
        ...
        config += Points.A.On ? Bits1.A : 0;
        config += Points.B.On ? Bits1.B : 0;
        config += Points.C.On ? Bits1.C : 0;
        config += Points.D.On ? Bits1.D : 0;
        config += Points.E.On ? Bits1.E : 0;
        config += Points.F.On ? Bits1.F : 0;
        config += Points.G.On ? Bits1.G : 0;
        config += Points.H.On ? Bits1.H : 0;
